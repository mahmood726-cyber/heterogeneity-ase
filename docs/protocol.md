        # Heterogeneity Ase: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/heterogeneity-ase.git

        ## Objective

        HeterogeneityASE is an R package implementing the Absolute Standardised Effect (ASE) heterogeneity estimator, providing a novel complement to I-squared with 24/24 validated tests.
        ...
        - Code: https://github.com/mahmood726-cyber/heterogeneity-ase.git
        - Dashboard: https://mahmood726-cyber.github.io/heterogeneity-ase/
